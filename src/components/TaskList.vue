<template>
    <div class="container">
        <div class="addTask">
            <input id="new task" type="taxt" v-model="nawTask">
            <button  type="botton" @click="addTask(nawTask)">Add New Task</button>
        </div>
        <div class="task-zone">
    ...
    computed:{
     ...
     methods:{
        ...
        addTask(nawTask){
            ...
            this.tasks.push({id: newId,  title: nawTask, status: 'todo'})
            this.nawTask = ""
        },
        onEdit(task){
